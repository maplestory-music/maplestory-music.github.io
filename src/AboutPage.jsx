  ...
  render() {
    return (
      <div>
        ...
        <h2>Source</h2>
          <p>
            The following GitHub projects power this site.
          </p>
          <div className='gh-project-entry'>
            ...
            <h4 className='gh-project-name'>maplebgm-db: Definitive MapleStory music database</h4>
          </div>
          <div className='gh-project-entry'>
            <GitHubButton
            ...
            <h4 className='gh-project-name'>maplestory-music: MapleStory Music website</h4>
          </div>
      </div>
    );
  }
